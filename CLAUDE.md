# TPilot project rules for Claude Code (transfer handoff, 2026-07-10)

This file is a full transfer of project rules + current state for continuing TPilot work
on a new computer. Save as `CLAUDE.md` in the project root on the new PC.
...
## 8. Claude Code workflow (required)
...
* For every Claude Code prompt: specify Mode, Model, Working directory.

## 14. How future prompts must be structured

Every task prompt to Claude Code contains:
