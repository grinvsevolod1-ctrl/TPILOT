...
REAL_NAMES = {
    # utcnow refactor (2026-08-16): extracted HNV2/health code reads the
    # clock through the module-level _tp_utc_now() seam -- extract it too.
    "_tp_utc_now",
